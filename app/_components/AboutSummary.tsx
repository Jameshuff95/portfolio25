...
const AboutSummary = () => {
  return (
    <div className="flex flex-col gap-2">
      <header>
        <h3 className="font-bold text-center text-xl">A Brief Summary</h3>
      </header>
      <p>
      ...
      <p>
        I believe that strong systems—digital or physical—start with the people
        who use them. So I champion learning, nudge curiosity, and keep things
        grounded with a bit of humor and good-faith teasing.
      </p>
      <p>
        My goal is to turn what I know into tools that help my team thrive, and
